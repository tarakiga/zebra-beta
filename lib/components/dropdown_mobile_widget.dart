...
import 'dropdown_mobile_model.dart';
export 'dropdown_mobile_model.dart';

class DropdownMobileWidget extends StatefulWidget {
  const DropdownMobileWidget({super.key});

  @override
  _DropdownMobileWidgetState createState() => _DropdownMobileWidgetState();
}
                  ...
                  children: [
                    Padding(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.network(
                          'https://images.unsplash.com/photo-1522529599102-193c0d76b5b6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxibGFjayUyMG1hbnxlbnwwfHx8fDE2OTQ2MzExOTZ8MA&ixlib=rb-4.0.3&q=80&w=1080',
                          width: 32.0,
                          height: 32.0,
                          fit: BoxFit.cover,
                        ),
